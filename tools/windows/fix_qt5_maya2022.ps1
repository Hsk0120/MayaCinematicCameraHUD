# Fix Qt5 CMake files for Maya 2022 - Remove DEBUG configurations
# Must be run as Administrator

$qtCmakeDir = "C:\Program Files\Autodesk\Maya2022\lib\cmake"
...
Write-Host "Backup files created with .backup2 extension" -ForegroundColor Gray
Write-Host ""
